...
global.databaseName = "testjira";
global.JiraAccountInfoStore = "jira";

async function getdb() {
    global.connection = await MongoClient.connect("mongodb+srv://sergiyshinderovskiy:3ePVGuAE76ziQNVJ@cluster0.ci09u.mongodb.net/testjira", {useNewUrlParser: true})
